...
Revision ID: a4e361be4c39
Revises: b679e5d2469f
Create Date: 2025-02-21 01:08:36.705424
...
revision: str = 'a4e361be4c39'
down_revision: Union[str, None] = 'b679e5d2469f'
...
def upgrade() -> None:
    ...
    sa.Column('last_opened_date', sa.TIMESTAMP(), nullable=True),
    sa.Column('created_on', sa.TIMESTAMP(), nullable=True),
